        ...
        <div id="container" style="width:100%">
            ...
            <form method="post">
                <div id="sandwich" style="width:50%; float: right; height:400;">
                    ...
                    <select name="DropSw" style="background-color: #F5F6CE;">
                        <option></option>
                    ...
                    <select name="DropCount" style="background-color: #F5F6CE;">
                    ...
                    <button type="submit" name ="AddToBasket" style="background-color: #F5F6CE; border-top-left-radius: 10px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; border-top-right-radius: 10px;">Tilf&#248j til kurv</button><br>
