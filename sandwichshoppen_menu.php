            ...
            <div id="menu" style="background-color:#04B431; width:100%; float:left; text-align: center">
                <center>
                    <a href="sandwichshoppen.php">
                        <button onmouseover="" style="width:400; background-color: #029727; border: 1px solid #444; cursor: pointer; border-top-left-radius: 50px;"><font size="6" color="#FFFFFF">Forside</font></button>
                    </a>
                    <button style="width:400; background-color: #029727; border: 1px solid #444;"><font size="6">Menu</font></button>
                    <a href="sandwichshoppen_kontakt.php">
                        <button onmouseover="" style="width:400; background-color: #029727; border: 1px solid #444; cursor: pointer; border-top-right-radius: 50px;"><font size="6" color="#FFFFFF">Kontakt Information</font></button>
                    </a>
                </center>
            </div>
